...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body
        className={`${inter.variable} min-h-screen bg-surface-muted font-sans text-slate-800 antialiased transition-colors dark:bg-surface-dark dark:text-slate-100`}
      >
        <ThemeProvider>
          <a
            href="#main-content"
